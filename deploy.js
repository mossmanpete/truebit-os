...
async function deploy() {
    ...
    let incentiveLayer = await deployContract('IncentiveLayer', {from: accounts[0], gas: 1000000}, [tru._address, exchangeRateOracle._address, interactive._address, fileSystem._address])
